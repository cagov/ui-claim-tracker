          ...
          <div className="work-in-progress-content">
            ...
            <span className="work-in-progress-message">
              <Trans i18nKey="work-in-progress.message">
                While we test this new part of UI Online, the information here may be limited for your claim. We&apos;re
                working to add information about common issues that lead to&nbsp;
                <a target="_blank" rel="noopener noreferrer" href="https://edd.ca.gov/unemployment/claim-status.htm">
                  pending payments
                </a>
              </Trans>
            </span>
